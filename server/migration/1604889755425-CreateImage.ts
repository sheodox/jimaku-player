...
export class CreateImage1604889755425 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "images" ("id" SERIAL NOT NULL, "large" bytea NOT NULL, "medium" bytea NOT NULL, "small" bytea NOT NULL, "sourceId" character varying NOT NULL, CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`
		);
