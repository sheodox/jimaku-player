...
<div class="row">
	...
	<label for="auto-copy-subtitles"
		>Auto-copy current subtitles
...
<div class="row">
	...
	<label for="invert-subtitle-alignment">
		Invert subtitle vertical alignment (<kbd title="Hotkey: i">I</kbd>)
		<span class="muted"
			>(i.e. if subtitles should be near the bottom this will make them show near the top). You'll likely want this
			enabled if you intend to watch with VRV's subtitles at the same time.</span
		>
	</label>
</div>
<div class="row">
	<fieldset>
		<legend> What should happen when a subtitle is clicked </legend>
...
<script>
	import { explainedSecondsStore, signedSecondsStore, showNameStore } from '../alignmentStore';
	...
	import { usesShowBasedSettings, showBasedSettings } from '../by-show-settings';
