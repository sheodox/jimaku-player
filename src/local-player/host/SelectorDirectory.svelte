...
<a class="button" href={getRouteToItem(directory)} on:click|preventDefault={() => selectPath(directory)}>
	<p class="name">
		{directory.name}
	</p>
	<p class="video-count muted">
		...
		{/if}
		<Icon icon="film" noPadding={true} />
		{directory.containedVideos} <span class="sr-only">Videos</span>
	</p>
</a>
